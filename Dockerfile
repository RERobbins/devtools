FROM quay.io/jupyter/pytorch-notebook:2024-01-06
...
# Create Conda environments for Python 3.8, 3.9, and 3.10 and install necessary packages in each environment
